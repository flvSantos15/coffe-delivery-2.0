export function Title() {
  return (
    <div className="flex flex-col items-start p-0 gap-[1rem] w-full md:w-full lg:w-[36.75rem] h-[8rem] md:h-[10rem] lg:h-[12rem]">
      <h1 className="font-serif font-extrabold text-left text-5xl md:text-[2.5rem] lg:text-[3rem] leading-[1.5rem] md:leading-[2.5rem] lg:leading-[3.875rem] text-base-title">
